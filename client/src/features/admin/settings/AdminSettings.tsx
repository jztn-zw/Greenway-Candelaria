...
const AdminSettings = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <Section title="System Maintenance" icon={Wrench}>
      ...
      <Section title="Security Policy" icon={Shield}>
        <div className="space-y-5">
      ...
      <Section title="Resident App Controls" icon={Smartphone}>
      ...
      <Section title="Driver App Controls" icon={Truck}>
        <div className="space-y-1">
          <ToggleRow
      ...
      <Section title="Account Registration" icon={UserPlus}>
        <div className="space-y-4">
          <ToggleRow
