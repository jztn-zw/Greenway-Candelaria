...
import { Bell, Sun, Moon, FileText, AlertTriangle, Truck, Users, Megaphone, MessageSquare, Shield, Route, WifiOff, CheckCheck } from "lucide-react";
import { Avatar, AvatarFallback } from "@/components/ui/avatar";
import { SidebarTrigger } from "@/components/ui/sidebar";
import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/popover";
import type { AdminNotification } from "./notifications/types";
import { mockAdminNotifications } from "./notifications/mockData";
...
const typeAccents: Record<string, string> = {
  ...
  "stale-report": "bg-amber-500/10 text-amber-600",
  ...
  "missing-route": "bg-amber-500/10 text-amber-600",
  ...
  return (
    <header className="h-14 border-b bg-background/95 backdrop-blur flex items-center justify-between px-4 shrink-0 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* User */}
        <button onClick={() => navigate("/admin/profile")} className="flex items-center gap-2 ml-1 pl-2 border-l hover:opacity-80 transition-opacity">
