...
import {
  ...
  CheckCircle2, AlertTriangle, Truck, Users, MessageSquare, Route
} from "lucide-react";
...
const notifPreferences = [
  ...
  { key: "newComment", label: "New Comment on Post", description: "When a resident comments on a published post", icon: MessageSquare },
];
