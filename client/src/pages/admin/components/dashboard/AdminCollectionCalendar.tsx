...
// Same schedule as Resident: Bio = Mon,Wed,Fri,Sun | Non-Bio = Tue,Thu,Sat
    ...
    <Card className="border border-border overflow-hidden">
      ...
      <CardContent className="px-4 sm:px-6 pb-4">
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <a href="/admin/schedule" className="text-xs text-primary hover:underline font-medium">
            View Calendar →
          </a>
        </div>
      </CardContent>
