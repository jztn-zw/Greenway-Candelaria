...
export type LandingSectionKey = keyof SectionContent;
...
export const DEFAULT_SECTIONS: LandingSection[] = [
  { id: "hero", label: "Hero", icon: "Image", visible: true, order: 0 },
  { id: "about", label: "About", icon: "BookOpen", visible: true, order: 1 },
  { id: "services", label: "Services", icon: "Grid3X3", visible: true, order: 2 },
  { id: "statistics", label: "Impact Statistics", icon: "BarChart3", visible: true, order: 3 },
  { id: "awards", label: "Awards & Recognition", icon: "Trophy", visible: true, order: 4 },
  { id: "blog", label: "News & Updates", icon: "Newspaper", visible: true, order: 5 },
  { id: "testimonials", label: "Testimonials", icon: "Quote", visible: true, order: 6 },
  { id: "faq", label: "FAQ", icon: "HelpCircle", visible: true, order: 7 },
  { id: "contact", label: "Contact", icon: "Mail", visible: true, order: 8 },
  { id: "footer", label: "Footer", icon: "LayoutTemplate", visible: true, locked: true, order: 9 },
];
...
export const DEFAULT_CONTENT: SectionContent = {
  ...
  faq: {
    ...
    subtitle: "Everything you need to know about GreenWay and how it serves the Candelaria community.",
...
export const DEFAULT_SECTION_META: Record<LandingSectionKey, LandingSectionMeta> = {
  hero: { updatedAt: null, updatedByName: null },
  about: { updatedAt: null, updatedByName: null },
  services: { updatedAt: null, updatedByName: null },
  statistics: { updatedAt: null, updatedByName: null },
  awards: { updatedAt: null, updatedByName: null },
  blog: { updatedAt: null, updatedByName: null },
  testimonials: { updatedAt: null, updatedByName: null },
  faq: { updatedAt: null, updatedByName: null },
  contact: { updatedAt: null, updatedByName: null },
  footer: { updatedAt: null, updatedByName: null },
};
