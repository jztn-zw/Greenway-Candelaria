...
const navGroups = [
  {
    label: "MAIN",
    items: [{ title: "Home", url: "/collector", icon: LayoutDashboard }],
  },
  {
    label: "OPERATIONS",
    items: [{ title: "Route & Map", url: "/collector/route-map", icon: Map }],
  },
  {
    label: "HISTORY",
    items: [{ title: "Route History", url: "/collector/route-history", icon: History }],
  },
];
