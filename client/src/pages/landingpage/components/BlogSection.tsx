...
import { BlogContent, DEFAULT_CONTENT } from "@/pages/admin/components/landingmanager/types";
...
const BlogSection = ({ content = DEFAULT_CONTENT.blog, posts = [] }: BlogSectionProps) => {
