...
import { DEFAULT_CONTENT, ServicesContent } from "@/pages/admin/components/landingmanager/types";
...
const ServicesSection = ({ content = DEFAULT_CONTENT.services }: ServicesSectionProps) => {
